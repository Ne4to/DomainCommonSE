...
{
	partial class SqlHighlightControl
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SqlHighlightControl));
			this.SuspendLayout();
			// 
			// txtEdit
			// 
			...
			this.Name = "SqlHighlightControl";
			this.Load += new System.EventHandler(this.SqlHighlightControl_Load);
